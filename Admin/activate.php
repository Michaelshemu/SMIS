...
$query = "select * from users,user_info where (users.info_id=user_info.info_id) and users.user_level!='admin' and status='0'";
...
<td>'.'<a href="processsss_activate.php?id='.$row['info_id'].'" style="text-decoration:none">Activate</a>'.'</td>
</tr>';
++$teacher_id;
}

...
<title>Administrator</title>
	...
	STUDENT REGISTRATION FORM:</strong></th></tr>
  <tr align="center" align="top">
	...
	<font face="Times New Roman, Times, serif" color=""></legend>
			<form  action="add_student.php" name="staff_registration_form" method="post">
        ...
        <tr>
         ...
         <label >ADD MULTIPLE STUDENTS FROM EXCEL</label>
<table border="2">
		...
		<tr><td colspan="3" align="center" background="photos/bg_footer.PNG"><a href="../sampleusers/STUDENT.xlsx" style="text-decoration:none"><font color="black" size="+1">Click here to view the sample of the excel</font></a></td></tr>
		</form>
</table>
  ...
  <?php 
    ...
    if(@$_GET['success'] == 'Sussessfully'){
        ...
        echo "<strong><font color='red'><a href='student_admin.php'>Successfully!</a></font></strong>";
    }else if(@$_GET['success'] == 'exist'){
     echo "<strong><font color='red'>user exist</font></strong>";    
    }
?> 

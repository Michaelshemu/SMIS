...
$query = "select * from users,user_info where (users.info_id=user_info.info_id) and users.user_level!='admin' and status='1'";
...
<td>'.'<a href="process_deactivate.php?id='.$row['info_id'].'" style="text-decoration:none">Deactivate</a>'.'</td>
</tr>';
++$teacher_id;
}

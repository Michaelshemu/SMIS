...
<td width="80%">
	...
	<table class="table table-condensed" style="background:wheat;" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input class="btn btn-primary" type="Submit" name="Change" id="" value="Submit" onclick="login()" />
	<input class="btn btn-primary" type="reset" name="reset" id="" value="Reset" /></td>
  </tr>
  <tr><td><a href="index.php" style="text-decoration:none">
<img src="../photos/undo_arrow_left_edit_back-128.png" align="left" width="30"/>Back</a></td></tr>

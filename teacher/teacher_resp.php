...
<title>Administrator</title>
  ...
  <tr align="center" align="top">
    <td id="clmenu">
        ...
        <li><a href="result_admin.php">Result</a></li>
                  <li></li>
...
$query = "select * from users,user_info,subjects where user_info.user_level='teacher' and (users.info_id=user_info.info_id) and (user_info.info_id=subjects.teacher_id)";
$rs = mysql_query($query) or die(mysql_error());
echo "<b><center><p>list of teacher and their responsible subject</p></center></b>";
$teacher_id = 1;
